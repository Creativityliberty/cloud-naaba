    ...
    <section id="contact-form" className="py-32 relative overflow-hidden bg-bg-primary z-20">
      ...
      <div className="container mx-auto max-w-[1240px] px-6 relative z-10">
        ...
        >
          <div className="p-8 rounded-[2rem] bg-amber-500/5 border border-amber-500/20 flex flex-col md:flex-row gap-6 items-start shadow-xl shadow-amber-500/5">
            ...
            <div>
              ...
              <div className="bg-black/40 border border-white/10 p-4 rounded-xl flex flex-wrap items-center gap-3">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 max-w-6xl mx-auto">
          ...
          >
            <div className="mb-10">
              <h2 className="text-3xl md:text-5xl font-bold font-display leading-[1.1] mb-4 text-white">
                  ...
                  <form key="form" onSubmit={handleSubmit} className="relative z-10 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full bg-black border border-white/10 rounded-2xl p-4 text-white hover:border-white/20 focus:outline-none focus:border-accent-primary/80 focus:bg-accent-primary/[0.02] transition-colors"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <select required className="w-full bg-black border border-white/10 rounded-2xl p-4 text-white focus:outline-none hover:border-white/20 focus:border-accent-primary/80 focus:bg-accent-primary/[0.02] transition-colors appearance-none cursor-pointer">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        rows={6}
                        className="w-full bg-black border border-white/10 rounded-2xl p-4 text-white hover:border-white/20 focus:outline-none focus:border-accent-primary/80 focus:bg-accent-primary/[0.02] transition-colors resize-none"
                      />
                    </div>
          ...
          >
            <h3 className="text-xl font-bold font-display text-text-primary mb-8 px-2 uppercase tracking-widest text-xs opacity-60">Coordonnées directes</h3>
